...
| [`agentic-ai/002-pydantic-ai.md`](ai/foundation/agentic-ai/002-pydantic-ai.md) | Pydantic AI from zero: agents, message roles, `instructions` versus `system_prompt`, structured output, tools, dependencies, grounding, retries, evals, and cost. The library the two exercises below are built with. |
